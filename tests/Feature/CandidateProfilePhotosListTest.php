...
class CandidateProfilePhotosListTest extends TestCase
{
    use RefreshDatabase;

    public function test_candidate_can_list_profile_photos(): void
    {
    ...
    public function test_guest_cannot_list_profile_photos(): void
    {
        $this->seed(RbacSeeder::class);
    ...
    public function test_non_candidate_receives_forbidden(): void
    {
        $this->seed(RbacSeeder::class);
    ...
    public function test_candidate_cannot_list_another_candidates_photos(): void
    {
        $this->seed(RbacSeeder::class);
