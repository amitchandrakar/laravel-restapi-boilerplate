...
class UpdateSeoSettingsRequest extends ApiFormRequest
{
    public function rules(): array
    {
        return [
            ...
            'googleAnalyticsEnabled' => ['sometimes', 'boolean'],
            'googleAnalyticsSnippet' => ['sometimes', 'nullable', 'string', 'max:20000'],

            'robotsEnabled' => ['sometimes', 'boolean'],
            'robotsTxt' => ['sometimes', 'nullable', 'string', 'max:20000'],

            'sitemapEnabled' => ['sometimes', 'boolean'],
            'sitemapUrls' => ['sometimes', 'nullable', 'string', 'max:20000'],

            'ogImage' => ['sometimes', 'nullable', 'string', 'max:2048'],
            'ogType' => ['sometimes', 'nullable', 'string', 'max:64'],

            'twitterCard' => ['sometimes', 'nullable', 'string', 'max:64'],
